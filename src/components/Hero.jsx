    ...
    <div>
      <div className="w-full grid lg:grid-cols-2   text-black lg:mt-32  mt-10 justify-between ">
        <div className="p-5">
          ...
          <p className="lg:pt-10 lg:text-xl text-center text-lg  lg:text-left font-normal ">
            we provide you access to luxury and affordable houses in the
            metaverse, get a chance to turn your imagination to reality at your
            comfort zone
          </p>
          <div className="flex lg:mt-20  mt-16 mx-auto ">
            <input
              type="text"
              placeholder="Search for location"
              aria-label="Search"
              type="search"
              className=" lg:w-[50%] lg:py-3 py-1.5  px-1 w-60 bg-white rounded-l-md border border-solid text-sm lg:text-lg border-gray-300 "
            />
        ...
        <div className="flex flex-row items-center  lg:mb-64 lg:p-2 xl:p-0 mx-auto 2xl:ml-40 ">
          <div className="flex flex-col mr-5 mt-28">
            ...
            <img
              src={img4}
              alt=""
              className="object-contain w-36 lg:w-60 2xl:w-80  "
            />
          </div>
